...
<form action="form34.php"  target="_blank" method="POST" >
	...
	<div class="pd-20 card-box mb-30">
		...
		<div class="form-group row">
			...
			<div class="col-sm-12 col-md-10">
				<input class="form-control" placeholder="Lütfen Öğrenci Adını Giriniz" type="text" name="ogrenciadi" required >
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-12 col-md-2 col-form-label">Öğrenci Soyadı</label>
			<div class="col-sm-12 col-md-10">
				<input class="form-control" placeholder="Lütfen Öğrenci Soyadını Giriniz" type="text" name="ogrencisoyadi" required >
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-12 col-md-2 col-form-label">Anabilim Dalı</label>
			<div class="col-sm-12 col-md-10">
				<input class="form-control" placeholder="Lütfen Anabilim Dalını Giriniz" type="text" name="anabilimdali" required >
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-12 col-md-2 col-form-label">Kayıt Tarihi</label>
			<div class="col-sm-12 col-md-10">
				<input type="date" class="form-control" placeholder="Lütfen Kayıt Tarihini Seçiniz" name="kayittarihi" required >
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-12 col-md-2 col-form-label">Tez Danışmanı</label>
			<div class="col-sm-12 col-md-10">
				<input class="form-control" placeholder="Lütfen Tez Danışmanını Giriniz" type="text" name="tezdanismani" required >
			</div>
		</div>
	</div>
	...
	<div class="pd-20 card-box mb-30">
		...
		<div class="row">
			<div class="col-md-4 col-sm-12">
				<div class="form-group">
					...
					<input type="text" name="turkcetezbasligi" id="turkcetezbasligi" class="form-control" placeholder="Tez Başlığını Giriniz" required >
				</div>
			</div>
			<div class="col-md-4 col-sm-12">
				<div class="form-group">
					<label>Anahtar Kelimeler</label>
					<input type="text" class="form-control" id="anahtarkelime" name="anahtarkelime" placeholder="Anahtar Kelimeleri Giriniz" required >
				</div>
			</div>
			<div class="col-md-4 col-sm-12">
				<div class="form-group">
					<label>İngilizce Tez Başlığı</label>
					<input type="text" name="ingilizcetezbasligi" id="ingilizcetezbasligi" class="form-control" placeholder="Tez Başlığını Giriniz" required >
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-md-4 col-sm-12">
				<div class="custom-control custom-radio mb-5">
					<input type="radio"  id="tezyazimdili1" name="tezyazimdili" value="0" class="custom-control-input" required >
			...
			<div class="col-md-4 col-sm-12">
				<div class="custom-control custom-radio mb-5">
					<input type="radio" value="1" id="tezyazimdili2" name="tezyazimdili" class="custom-control-input" required >
		...
		<div class="row">
			...
			<div class="col-md-2 col-sm-12">
				<div class="custom-control custom-radio mb-5">
					<input value="0" type="radio"  id="calismatarzi1" name="calismatarzi" class="custom-control-input" required >
					<label class="custom-control-label"  for="calismatarzi1">Deneysel</label>
				</div>
			</div>
			<div class="col-md-2 col-sm-12">
				<div class="custom-control custom-radio mb-5">
					<input value="1" type="radio" id="calismatarzi2" name="calismatarzi" class="custom-control-input" required >
					<label class="custom-control-label" for="calismatarzi2">Teorik</label>
				</div>
			</div>
			<div class="col-md-2 col-sm-12">
				<div class="custom-control custom-radio mb-5">
					<input value="2" type="radio" id="calismatarzi3" name="calismatarzi" class="custom-control-input" required >
					<label class="custom-control-label" for="calismatarzi3">Simülasyon</label>
				</div>
			</div>
			<div class="col-md-2 col-sm-12">
				<div class="custom-control custom-radio mb-5">
					<input value="3" type="radio" id="calismatarzi4" name="calismatarzi" class="custom-control-input" required >
					<label class="custom-control-label" for="calismatarzi4">Sistem/Araç/Yazılım Geliştirme</label>
				</div>
			</div>
			<div class="col-md-2 col-sm-12">
				<div class="custom-control custom-radio mb-5">
					<input value="4" type="radio" id="calismatarzi5" name="calismatarzi" class="custom-control-input" required >
	...
	<div class="pd-20 card-box mb-30">
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-12">
				<div class="custom-control custom-radio mb-5">
					<input value="0" type="radio" id="etikkurulizni1" name="etikkurulizni" class="custom-control-input" required >
			...
			<div class="col-md-4 col-sm-12">
				<div class="custom-control custom-radio mb-5">
					<input value="1" type="radio" id="etikkurulizni2" name="etikkurulizni" class="custom-control-input" required >
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-12">
				<div class="custom-control custom-radio mb-5">
					<input type="radio" value="0" id="verikullanimiizni1" name="verikullanimiizni" class="custom-control-input" required >
			...
			<div class="col-md-4 col-sm-12">
				<div class="custom-control custom-radio mb-5">
					<input value="1" type="radio" value="1" id="verikullanimiizni2" name="verikullanimiizni" class="custom-control-input" required >
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-12">
				<div class="custom-control custom-radio mb-5">
					<input type="radio" value="0" id="kurumkurulusizni1" name="kurumkurulusizni" class="custom-control-input" required >
			...
			<div class="col-md-4 col-sm-12">
				<div class="custom-control custom-radio mb-5">
					<input type="radio" value="1" id="kurumkurulusizni2" name="kurumkurulusizni" class="custom-control-input" required >
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-12">
				<div class="custom-control custom-radio mb-5">
					<input type="radio" value="0" id="fikirhaksahipliğibeyani1" name="fikirhaksahipliğibeyani" class="custom-control-input" required >
			...
			<div class="col-md-4 col-sm-12">
				<div class="custom-control custom-radio mb-5">
					<input type="radio" value="1" id="fikirhaksahipliğibeyani2" name="fikirhaksahipliğibeyani" class="custom-control-input" required >
	...
	<div class="pd-20 card-box mb-30">
		...
		<div class="row">
			<div class="col-md-4 col-sm-12">
				<div class="custom-control custom-radio mb-5">
					<input type="radio"  id="savunmavekonudegisikligi1"   name="savunmavekonudegisikligi" class="custom-control-input" value="0" >
			...
			<div class="col-md-4 col-sm-12">
				<div class="custom-control custom-radio mb-5">
					<input type="radio"  id="savunmavekonudegisikligi2" name="savunmavekonudegisikligi" class="custom-control-input" value="1" >
			...
			<div class="col-md-4 col-sm-12">
				<div class="custom-control custom-radio mb-5">
					<input type="radio"  id="savunmavekonudegisikligi3" name="savunmavekonudegisikligi" class="custom-control-input" value="2" >
	...
	<div class="pd-20 card-box mb-30">
		...
		<div class="form-group row">
			...
			<div class="col-sm-12 col-md-10">
				<input class="form-control" placeholder="Lütfen Toplantı Yerini Giriniz" type="text" name="toplantiyeri" required >
			</div>
		</div>
...
//33 den gelecek
  ...
  icon: 'error',
  title: 'Hata',
  text: 'Öğrenci bilgileri Çekilemedi!',
...
if(typeof(veri[0]) != "undefined"){
  ...
  icon: 'error',
  title: 'Hata',
  text: 'Öğrenici Bilgileri Çekilemedi!',
  showConfirmButton: false,
})}})
...
console.log(veri[0]);
  ...
  icon: 'error',
  title: 'Hata',
  text: 'Form 33 verileri Çekilemedi!',
  showConfirmButton: false,
})}
